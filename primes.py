...
def find(limit):                                        # limit(int) -- any positive number; --> function returns a list of primes
    working = []
    output = []
...
def find_distincts(n, output_format="*"):                                           # n(int) -- any positive number; 
                                                                                # output_format(str, default="*") -- give "#" --> function returns the number of distinct prime divisors
                                                                                #                                 -- don't give anything --> function returns the list of distinct prime divisors
...
## --> find prime factors
def find_prime_factors(n):                          # n(int) -- any positive number; --> function returns a list of prime factors of n
